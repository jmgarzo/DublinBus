...
public class BusStopAdapter extends RecyclerView.Adapter<BusStopAdapter.BusStopAdapterViewHolder> {
    ...
    public class BusStopAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public BusStopAdapterViewHolder(View view) {
            super(view);
            mBusStopName = (TextView) view.findViewById(R.id.list_item_bus_stop_name);
            mBusStopShortName = (TextView) view.findViewById(R.id.list_item_bus_stop_short_name);
            mBusStopShortNameLocalized = (TextView) view.findViewById(R.id.list_item_bus_stop_short_name_localized);
