...
public class DublinBusContract {
    ...
    public static final class RouteEntry implements BaseColumns {
        ...
        public static Uri buildRoutesWithBusStop(String busStopName) {
            return CONTENT_URI.buildUpon().appendPath(busStopName).build();
        }
        public static String getBusNumberFromUri(Uri uri) {
            return uri.getPathSegments().get(1);
        }
